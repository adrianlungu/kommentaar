...
func TestFindType(t *testing.T) {
	...
	t.Run("relative", func(t *testing.T) {
		...
		if pkg != "github.com/adrianlungu/kommentaar/example/exampleimport" {
			t.Fatalf("pkg == %v", pkg)
		}
	...
	t.Run("error", func(t *testing.T) {
		tests := []struct {
			...
			},
			{
				...
				`could not find type "doesntexist" in package "github.com/adrianlungu/kommentaar/example/exampleimport"`,
			},
		}
